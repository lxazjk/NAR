...
torchrun --standalone --nnodes=1 --nproc_per_node=8 \
  ...
  --cloud-save-path ./cloud_ckpt_vbranch_last1_hvgate_reg0p1 \
  ...
  --vertical-start-layer 23 \
  --fid-every 10 \
  --fid-ref ./pretrained_models/VIRTUAL_imagenet256_labeled.npz \
  --fid-num-samples 50000 --fid-batch-size 64 \
  --fid-cfg-scale 2.0 \
  --fid-sample-dir ./samples_vbranch_last1_hvgate_reg0p1_eval10 \
  --vq-ckpt ./pretrained_models/vq_ds16_c2i.pt \
  --wandb-project c2i_nar \
  --wandb-name vbranch_last1_hvgate_reg0p1_eval10_gptl \
  --no-compile
